...
var require_util$7 = __commonJSMin(((exports, module) => {
...
var require_constants$3 = __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_redirect_interceptor = __commonJSMin(((exports, module) => {
...
var require_redirect = __commonJSMin(((exports, module) => {
	const RedirectHandler = require_redirect_handler();
	module.exports = (opts) => {
...
var require_retry = __commonJSMin(((exports, module) => {
	const RetryHandler = require_retry_handler();
	...
	exec() {
		return __awaiter$3(this, void 0, void 0, function* () {
			...
			return new Promise((resolve, reject) => __awaiter$3(this, void 0, void 0, function* () {
				...
				if (this.options.cwd && !(yield exists(this.options.cwd))) return reject(new Error(`The cwd: ${this.options.cwd} does not exist!`));
...
async function run() {
	...
	const privateKeyName = getInput("private-key-name");
	checkHost(host);
	await checkPrivateKey(privateKey);
	checkPrivateKeyName(privateKeyName);
	const sshPath = await initializeSSH();
	exportVariable("SSH_PATH", sshPath);
	setOutput("ssh-path", sshPath);
	console.log("SSH initialized.");
	const sshAgent = await initializeSSHAgent();
	exportVariable("SSH_AGENT_PID", sshAgent.pid);
	setOutput("ssh-agent-pid", sshAgent.pid);
	exportVariable("SSH_AUTH_SOCK", sshAgent.socket);
	setOutput("ssh-auth-sock", sshAgent.socket);
