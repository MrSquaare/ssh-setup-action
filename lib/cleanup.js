...
if (getState("started-agent") === "false") console.log("SSH agent was not started by this action, skipping cleanup");
else try {
	...
	else console.warn("Error stopping the SSH agent, proceeding anyway");
}
//#endregion
export {};
